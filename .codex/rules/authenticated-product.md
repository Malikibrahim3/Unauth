...
- Tables, drawers, dialogs, forms, statuses, metrics, loading, empty, stale, and error states use the authoritative component families documented in `styles/authenticated/README.md`.
