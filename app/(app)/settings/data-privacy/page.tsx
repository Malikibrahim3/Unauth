    ...
    <SettingsPageShell title="Data & privacy" subtitle="Understand how merchant and customer data is scoped, retained, and removed.">
      <Surface structure="working" aria-label="Data and privacy controls">
        ...
        <JoinedSection className="p-4 sm:p-5">
          ...
          <div className="ua-text-label mt-3 flex flex-wrap gap-x-4 gap-y-2"><Link href="/settings/audit-trail" className="text-[var(--ua-text-link)] hover:underline">View audit trail</Link><Link href="/legal/privacy" className="text-[var(--ua-text-link)] hover:underline">Privacy policy</Link><Link href="/legal/data-handling" className="text-[var(--ua-text-link)] hover:underline">Data handling</Link><Link href="/legal/dpa" className="text-[var(--ua-text-link)] hover:underline">Data processing agreement</Link></div>
        </JoinedSection>
      </Surface>
    </SettingsPageShell>
  );
