 ...
 * `.ua-route-settle` (styles/authenticated/surfaces.css) so it stays inert
 * under reduced motion and capture mode via the existing global rules there.
 */
export default function AppTemplate({ children }: { children: React.ReactNode }) {
  return (
    <div className="ua-route-settle" style={{ minHeight: '100%' }}>
      {children}
    </div>
  );
}
