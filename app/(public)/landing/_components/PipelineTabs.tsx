...
const STEPS = [
  ...
  },
  {
    ...
    stat: '0.92', unit: 'risk score',
    headline: 'Scored verdict and evidence packet, ready to act on.',
    body: 'You get the risk score, confidence grade, every signal that fired, and a formatted evidence packet — ready to review, act on, or submit for dispute.',
