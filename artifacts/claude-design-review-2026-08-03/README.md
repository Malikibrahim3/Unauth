# Unauth authenticated design-review capture
...
- [Flat all-in-one folder](../claude-design-review-2026-08-03-all-in-one/README.md) — every screenshot, contact sheet, and document directly together in one directory.
...
- [Contact sheet 1 — foundations and queues](contact-sheet/01-foundations-and-queues.jpg)
- [Contact sheet 2 — dashboard, settings, and utility](contact-sheet/02-dashboard-settings-and-utility.jpg)
- [Contact sheet 3 — expanded and detail states](contact-sheet/03-expanded-and-detail-states.jpg)
- [Contact sheet 4 — deep settings states](contact-sheet/04-settings-deep-dive.jpg)
