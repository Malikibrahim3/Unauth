...
type BlockRailChartProps = {
  ...
  /** Unrealised/outstanding remainder — quiet dashboards use a flat neutral tail. */
  remainder?: number;
  pins?: BlockRailPin[];
  compact?: boolean;
};

/** Block rail with pin annotations and a flat neutral remainder. */
    ...
    <div>
      ...
      >
        {blocks.map((block) => {
          ...
          const body = <span className={styles[block.tone]} style={{ display: 'block', width: '100%', height: '100%', borderRadius: 'var(--ua-radius-control)' }} />;
          return (
        ...
        {remainder && remainder > 0 ? (
          <div
            className={styles.railRemainder}
