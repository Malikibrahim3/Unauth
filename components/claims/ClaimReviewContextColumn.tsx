  ...
  return (
    <div className="min-w-0 space-y-6">
      ...
      >
        {SECTION_LINKS.map((section) => (
          <a
            ...
            className="shrink-0 border-b border-transparent px-0.5 py-2.5 text-[length:var(--ua-text-metadata-size)] font-semibold text-[var(--ua-text-secondary)] hover:border-[var(--ua-border-strong)] hover:text-[var(--ua-text-primary)] focus-visible:shadow-[var(--ua-shadow-focus)]"
          >
            {section.label}
          </a>
        ))}
      ...
      <section id="case-evidence" className="scroll-mt-20 space-y-4" aria-labelledby="case-evidence-title">
        ...
        <div>
          <h2 id="case-evidence-title" className="text-[length:var(--ua-text-section-title-size)] font-semibold leading-[var(--ua-text-section-title-leading)] text-[var(--ua-text-primary)]">Evidence & recommendations</h2>
        ...
        {decisionStale && !decisionLoading ? (
          <p role="status" className="text-xs text-[var(--ua-warning)]">
      ...
      <section id="case-responsibility" className="scroll-mt-20 space-y-4" aria-labelledby="case-responsibility-title">
        <div>
          <h2 id="case-responsibility-title" className="text-[length:var(--ua-text-section-title-size)] font-semibold leading-[var(--ua-text-section-title-leading)] text-[var(--ua-text-primary)]">Responsibility</h2>
      ...
      <section id="case-recovery" className="scroll-mt-20 space-y-4" aria-labelledby="case-recovery-title">
        <div>
          <h2 id="case-recovery-title" className="text-[length:var(--ua-text-section-title-size)] font-semibold leading-[var(--ua-text-section-title-leading)] text-[var(--ua-text-primary)]">Recovery</h2>
      ...
      <section id="case-activity" className="scroll-mt-20 space-y-4" aria-labelledby="case-activity-title">
        ...
        <div>
          <h2 id="case-activity-title" className="text-[length:var(--ua-text-section-title-size)] font-semibold leading-[var(--ua-text-section-title-leading)] text-[var(--ua-text-primary)]">Activity</h2>
