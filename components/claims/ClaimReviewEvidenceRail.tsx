  ...
  return (
    <>
      ...
      >
        {!claimId ? (
          ...
          <div className="space-y-2 text-xs leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            <p>
              Evidence is collected from connected commerce, helpdesk, tracking, carrier, payment, returns, warehouse, marketplace, ERP, or email sources.
            </p>
            <p>
      ...
      >
        <div className="space-y-2 text-xs leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          <p>
            External replies are ingested from connected helpdesk, email, API, ERP, WMS, marketplace, payment, or internal communication sources and matched to cases by source identifiers and confidence.
          </p>
          <p>
