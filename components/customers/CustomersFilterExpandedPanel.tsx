...
{/* ── Inline expanding filter panel ──────────────────────── */}
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
            ...
            <div className="lg:col-span-3">
              <label htmlFor="customers-filter-risk" className="block text-xs mb-1.5" style={{ color: 'var(--text-subtle)' }}>Match confidence</label>
              <select
...
type="button"               onClick={() => setAdvancedOpen((v) => !v)}
            ...
            {advancedOpen && (
              <div className="mt-4 space-y-4">
                ...
                {/* Identity */}
                <div>
                  <p className="text-xs font-semibold mb-2" style={{ color: 'var(--ink-secondary)' }}>Identity</p>
                ...
                {/* Match confidence */}
                <div>
                  <p className="text-xs font-semibold mb-2" style={{ color: 'var(--ink-secondary)' }}>Match confidence</p>
                  <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 max-w-md">
                    <input
                      key={searchParams.get('riskMin')}
                      type="number" min={0} max={100} aria-label="Minimum match confidence"
                      placeholder="Min (0)"
                    ...
                    <input
                      ...
                      type="number" min={0} max={100} aria-label="Maximum match confidence"
                      placeholder="Max (100)"
                ...
                {/* Behaviour */}
                <div>
                  <p className="text-xs font-semibold mb-2" style={{ color: 'var(--ink-secondary)' }}>Behaviour</p>
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    {[
                      ...
                      <div key={label} className="space-y-1">
                        <label htmlFor={`customers-filter-${key}`} className="text-xs" style={{ color: 'var(--text-subtle)' }}>{label}</label>
                ...
                {/* Date ranges */}
                <div>
                  <p className="text-xs font-semibold mb-2" style={{ color: 'var(--ink-secondary)' }}>Date ranges</p>
                ...
                {/* Identity signal */}
                <div>
                  <p className="text-xs font-semibold mb-2" style={{ color: 'var(--ink-secondary)' }}>Identity signal</p>
