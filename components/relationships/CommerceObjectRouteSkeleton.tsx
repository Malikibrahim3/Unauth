...
/** Geometry-matched loading state for the Phase 19 connected-object family. */
export function CommerceObjectRouteSkeleton({ title }: { title: string }) {
  return (
    <div
      className="mx-auto w-full max-w-[1500px] space-y-4 px-4 pb-6 pt-4 sm:px-5"
      aria-busy="true"
      aria-label={title}
      data-state-id="commerce-object-loading"
    >
