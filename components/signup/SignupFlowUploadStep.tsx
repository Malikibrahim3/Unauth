...
export function SignupFlowUploadStep({ state, onFileSelection, onRunAudit }: SignupFlowUploadStepProps) {
  return (
    <>
      ...
      <p className="mt-4 text-base leading-7" style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-serif, serif)' }}>
      ...
      {state.verificationFallback ? (
        <div
          ...
          style={{ borderColor: 'var(--border)', background: 'var(--surface-base)', color: 'var(--text-secondary)' }}
        >
