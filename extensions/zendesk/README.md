...
1. Zip the contents of this folder (`manifest.json` and `index.html` at the root of the zip — not the parent folder name).
...
You can also download a pre-built zip from **Unauth → Settings → Integrations → Zendesk**.
