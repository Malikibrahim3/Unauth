...
export const SIGNAL_COPY: Record<string, SignalCopy> = {
  ...
  crossMerchantSignal: {
    ...
    contextNote: 'The profile is seen across multiple merchants through privacy-safe aggregate evidence.',
  ...
  networkDeviceLink: {
    ...
    contextNote: 'The device pattern supports the cross-merchant identity context.',
