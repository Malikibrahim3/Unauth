...
export function buildNarrative(pkg: EvidencePackage): string {
  ...
  lines.push('')
  lines.push(
    `This report was generated by Unauth on ${fmt(generatedAt)} and carries reference ${referenceNumber}. It presents evidence and claim-history context from ${merchant.name}'s own records. Merchants may use this information to support chargeback dispute processes at their discretion. Unauth does not guarantee dispute outcomes.`
  )
