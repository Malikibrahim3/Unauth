 ...
 *
 * Production reads real time. Deterministic contexts such as tests and seed
 * generation pin an explicit `asOf` so that two
...
/**
 * Pins the clock. Intended for seed generation and tests; a
